...
if(isset($_POST['submit'])) {
  ...
  if(!empty($error_msg)){
    header("Location: about_page_text.php?source=edit_about_page_text&failed=true$error_msg&name=$title&subtitle=$subtitle&description=$description");
  }else{
    editSimplePageText($title, $subtitle, $description, $page_id);

    header("Location: about_page_text.php");
    exit();
  }
}
?>

<?php $page_title = "Edit About Us page text"; ?>
