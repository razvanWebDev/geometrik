...
if(isset($_POST['submit'])) {
  ...
  if(!empty($error_msg)){
    header("Location: contact_page_text.php?source=edit_contact_page_text&failed=true$error_msg&name=$title&subtitle=$subtitle&description=$description");
  }else{
    editSimplePageText($title, $subtitle, $description, $page_id);

    header("Location: contact_page_text.php");
    exit();
  }
}
?>

<?php $page_title = "Edit Contact Us page text"; ?>
