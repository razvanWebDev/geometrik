...
<?php $page_title = "About Us page text"; ?>
...
<section class="content">
  ...
  <div class="card card-solid">
    ...
    <a href="about_page_text.php?source=edit_about_page_text" class="btn bg-primary mb-4">
      <i class="fas fa-edit mr-2"></i>Edit page text
    </a>
    <div class="simple-page-description">
      <?php 
        $query = "SELECT * FROM simple_pages_text WHERE id=1 ORDER BY id LIMIT 1";
